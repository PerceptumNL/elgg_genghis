...
class ElggKhanExercise extends ElggObject {
	...
	protected function initializeAttributes() {
		...
		$this->attributes['subtype'] = "khan_exercise";
	}

//	public function save() {
//		/*----- from Genghis/libs/createExercise.php-----*/
//		$query = "SELECT * FROM
//				`khan_exercises`.`khan_question`
//				WHERE `question_author`= '".$user."' AND `question_course`= '" .$course."';";
//
...
//			mysql_query($query);	
//		}
//		$this->question_id = mysql_insert_id();
//		parent::save();
//        return true;
//	}
	...
	public function renderExercise() {
		return "Rendering exercise!";
	}
